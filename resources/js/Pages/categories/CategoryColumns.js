...
export const statuses = [
  {
    value: 'active',
    label: 'Active',
    icon: h(Check, { class: '!text-emerald-500' })
  },
  {
    value: 'inactive',
    label: 'InActive',
...
export const columns = [
  ...
  },
  {
    accessorKey: 'parent',
    header: ({ column }) =>
      h(DataTableColumnHeader, { column, title: 'Parent Category' }),
    cell: ({ row }) => {
  ...
  },
  {
    ...
    cell: ({ row }) =>
      h('div', { class: 'max-w-[500px] truncate' }, row.getValue('name')),
  ...
  },
  {
    ...
    header: ({ column }) =>
      h(DataTableColumnHeader, { column, title: 'Products' }),
    cell: ({ row }) =>
      h(
        'div',
